...
cred = credentials.Certificate("./iuh-19471481-firebase-adminsdk-ycqoj-99a17b3521.json")
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-19471481').where(u'DEALSIZE', u'==', 'Large').stream())
        ...
        html.Div(
            children=[
                ...
                html.Div(
                    children =[
                        html.H5(
                            children="IUH-DHHTTT16A-19471481-HUỲNH THỊ TRÂN"
                        )   
                    ]
                    , className="col-6"   
                )
                    ...
                    children=[
                        html.Div(
                            children=[
                                ...
                                html.P(
                                    children= [doanhso, "$"], className='text-danger'
                                )
                            ], className="card p-2"
                        )
                    ...
                    children=[
                        html.Div(
                            children=[
                                ...
                                html.P(
                                    children= [loinhuan, "$"], className='text-danger'
                                )
                            ], className="card p-2"
                        )
                    ], className="col-lg-3 col-md-6 mb-4"       
                    ...
                    children=[
                        html.Div(
                            children=[
                                ...
                                html.P(
                                    children=[topDoanhSo, "$"], className='text-danger'
                                )
                            ], className="card p-2"
                        )
                    ]   , className="col-lg-3 col-md-6 mb-4"    
                    ...
                    children=[
                        html.Div(
                            children=[
                                ...
                                html.P(
                                    children=[topLoiNhuan, "$"], className='text-danger'
                                )
                            ], className="card p-2"
                        )
                    ], className="col-lg-3 col-md-6 mb-4"  
